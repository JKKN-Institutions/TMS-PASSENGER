...
// Run this in the browser console on https://tms-passenger-taupe.vercel.app/
...
const isProductionRedirect = config.redirectUri?.includes('tms-passenger-taupe.vercel.app');
const isProductionDriverRedirect = config.driverRedirectUri?.includes('tms-passenger-taupe.vercel.app');
...
const isCorrectDomain = window.location.hostname === 'tms-passenger-taupe.vercel.app';
